...
public class NavigationEjemplo2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_navigation_ejemplo2);

        toolbar = (Toolbar) findViewById(R.id.toolbarEjemplo2);
        drawerLayout = (DrawerLayout) findViewById(R.id.drawerLayoutEjemplo2);
        navigationView = (NavigationView) findViewById(R.id.navigationEjemplo2);
